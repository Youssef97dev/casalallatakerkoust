...
const Activities = () => {
  return (
    <div className="relative w-full h-[150vh] lg:h-screen">
      <div className="absolute z-20 right-0 lg:right-[181px] w-[90%] lg:w-1/2 h-fit flex flex-col justify-center items-start gap-5  p-5 lg:p-10 top-[320px] lg:top-1/2 -translate-y-0 lg:-translate-y-1/2 bg-[#EDE5D9]">
      ...
      <div className="z-10 absolute left-0 w-[90%] lg:w-1/2 h-full">
        <Image
          ...
          width={500}
          height={500}
          className="object-cover h-[400px] lg:h-screen"
        />
      </div>
    </div>
  );
