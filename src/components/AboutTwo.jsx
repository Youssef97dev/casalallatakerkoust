  ...
  return (
    ...
    >
      ...
      <p className="text-[15px] leading-[25.5px] font-light italic pt-5 px-0 lg:px-52">
        {
          "Embrace the magnetic energy of free spirits, laughter, conversations, friendships, and rejuvenating vibes of CASA LALLA TAKERKOUST, inspired by Mediterranean culture and modern minimalism"
        }
      </p>
