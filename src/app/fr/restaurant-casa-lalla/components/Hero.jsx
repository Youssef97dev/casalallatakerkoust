...
const Hero = () => {
  return (
    <div id="hero" className="relative w-full h-screen">
      ...
      <div className="absolute inset-0 w-full flex justify-center text-center items-center font-lora text-white text-[24px] leading-[40px] lg:text-[32px] italic lg:leading-[60px] px-2 lg:px-0">
        <h1>
