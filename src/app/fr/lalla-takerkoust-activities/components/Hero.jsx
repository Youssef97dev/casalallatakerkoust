  ...
  return (
    <div id="hero" className="relative w-full h-screen">
      ...
      <div className="w-full h-full block lg:hidden">
        <Image
          src="/images/casalalla-takerkoust-vibes-agafay-activities-hero-mobile.jpg"
          alt="casa lalla takerkoust, agafay vibes"
          width={1500}
          height={1500}
          className={`w-full h-full object-cover`}
      ...
      <div className="absolute inset-0 w-full flex justify-center text-center items-center font-lora text-white text-[24px] leading-[40px] italic lg:text-[40px] lg:leading-[60px] px-2 lg:px-0">
